    ...
    <div className="user-profile-wrapper">
      <div className="container-fluid py-2 py-sm-3 py-md-4 px-2 px-sm-3">
        ...
        <div className="row g-3 g-md-4">
          ...
          <div className="col-12">
            <PanSection user={user} setUser={setUser} addPan={addPan} setShowCropModal={setShowCropModal} setPreviewUrl={setPreviewUrl} setCrop={setCrop} token={token} setIsPanImage={setIsPanImage} />
          </div>
          <div className="col-12">
          ...
          <div className="col-12">
            <EducationSection user={user} setUser={setUser} token={token} />
          </div>
          <div className="col-12">
            <ExperienceSection user={user} setUser={setUser} token={token} />
          </div>
          <div className="col-12">
