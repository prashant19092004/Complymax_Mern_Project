    ...
    <div className="supervisor_hire position-relative w-full">
      ...
      <section ref={enquiryref} className="enquiry-section">
          ...
          <form
            ...
            onSubmit={(e) => {
              e.preventDefault();
              warningref.current.style.scale = 1;
            }}
          >
              ...
              <div className="input-div w-full">
                <label
                  ...
                  style={{
                    ...
                    padding: "8px 12px",
                    borderRadius: "4px",
                    backgroundColor: notApplicable ? "#e8f5e9" : "#f5f5f5",
                ...
                >
                  ...
                  <span
                    style={{
                      fontSize: "16px",
                      fontWeight: "500",
                      color: notApplicable ? "#2e7d32" : "#333",
                    }}
                  >
                    Not Applicable
                  </span>
                ...
                <input
                  required
                  type="text"
                  value={saveData.uan_number}
                  onChange={pfesicChangeHandler}
                  name="uan_number"
                  id="uan_number"
