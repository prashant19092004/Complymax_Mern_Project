...
import { FaHome, FaUserCircle, FaHeadset } from 'react-icons/fa';
...
const SupervisorDashboard = () => {
  ...
  useEffect(() => {
    ...
    const navItems = [
        { path: "/supervisor_dashboard/", icon: <FaHome />, label: "Dashboard" },
        { path: "/supervisor_dashboard/profile", icon: <FaUserCircle />, label: "Profile" },
        { path: "/supervisor_dashboard/support", icon: <FaHeadset />, label: "Support 24/7" }
    ];
