                ...
                <div className="row g-6 mb-6 gy-6">
                    <div className="col-xl-3 col-sm-6 col-12 py-3">
                        <div className="card shadow border-0">
                            <Link to="/user_dashboard/offer-letters">
                    ...
                    <div className="col-xl-3 col-sm-6 col-12 py-3">
                        <div className="card shadow border-0">
                            <div className="card-body">
                                <div className="row">
                                    <div className="col">
                                        <span className="h6 font-semibold text-muted text-sm d-block mb-2">Mark Attendence</span>
                                        {/* <span className="h3 font-bold mb-0">215</span> */}
                                    </div>
                                    <div className="col-auto">
                                        <div className="icon icon-shape text-white text-lg rounded-circle" id='icon_shape'>
                    ...
                    <div className="col-xl-3 col-sm-6 col-12 py-3">
                        <div className="card shadow border-0">
                            <Link to="/user_dashboard/leave-management">
                                <div className="card-body">
                                    <div className="row">
                                        <div className="col">
                                            <span className="h6 font-semibold text-muted text-sm d-block mb-2">Leave Application</span>
                                            {/* <span className="h3 font-bold mb-0">215</span> */}
                                        </div>
                                        <div className="col-auto">
                                            <div className="icon icon-shape text-white text-lg rounded-circle" id='icon_shape'>
