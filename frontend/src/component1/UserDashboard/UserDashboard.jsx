...
import { FaHome, FaChartBar, FaUser, FaUserPlus, FaHeadset, FaUserCircle } from 'react-icons/fa';
...
const UserDashboard = () => {
  ...
  useEffect(() => {
    ...
    const navItems = [
        { path: "/user_dashboard/dashboard", icon: <FaHome />, label: "Dashboard", show: user?.job },
        { path: "/user_dashboard/", icon: <FaHome />, label: "Jobs", show: user && !user.job },
        { path: "/user_dashboard/user_profile", icon: <FaUser />, label: "Profile", show: true },
        { path: "/user_dashboard/dashboard", icon: <FaChartBar />, label: "Add Job Experience", show: true },
        { path: "/user_dashboard/dashboard", icon: <FaUserPlus />, label: "Emergency Contact No.", show: true },
        { path: "/user_dashboard/dashboard", icon: <FaHeadset />, label: "Support 24/7", show: true }
    ];
